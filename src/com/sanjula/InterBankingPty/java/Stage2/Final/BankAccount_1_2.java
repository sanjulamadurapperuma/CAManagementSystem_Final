package com.sanjula.InterBankingPty.java.Stage2.Final;
...
public class BankAccount_1_2 {
        ...
        do{
            ...
            if(selectedOption == 1){
                ...
                do{
                    ...
                    double accBalance = getAccountBalance(sc, "Enter the opening account balance ($): ");
                    while(accBalance < 0){
    ...
    private static double getAccountBalance(Scanner scanner, String message){
    ...
    private static void transfer(Customer customer){
        ...
        int fromAccountNumber = getAccountNumber(scanner, "");
        System.out.println("Enter the account number you want to transfer money to : ");
        int toAccountNumber = getAccountNumber(scanner, "");
        ...
        if(!(balanceTransferredFrom - amountToTransfer < 0)){
            ...
            if(numberTransferredFrom == numberTransferredTo){
                System.out.println("ERROR : You are not allowed to transfer money between the same account");
            } else{
                if(transferFrom != null && transferTo != null){
                    ...
                    System.out.println("ERROR : One or more of the transfer account numbers " +
                            "returned null values.");
                }
            }
        } else{
            System.out.println("ERROR : This transaction is not allowed because the account from " +
                    "which you want to withdraw money has inadequate funds or the specified account(s) does not exist");
        }
    }

}//End of BankAccount_1_2 class

class Customer {//Start of Customer class
    private String name;
    ...
    public void addBankAccount(BankAccount account) {
        this.getBankAccountsList().add(account);
    }
